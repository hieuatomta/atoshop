...
(function (e, t) {
    ...
    function i() {
        for (; y.length;) h.unsubscribe(y.shift())
    }
    ...
    function r(e, t, n, i, c) {
        ...
        return function (c) {
            var o;
            l.resolver.compare(c.topic, e, r) && (r.resolverNoCache || (o = t[n] = t[n] || [], o.push(c)), c.cacheKeys.push(n), i && i(c))
        }
    }

    function o(e, t) {
        return {
            channel: l.SYSTEM_CHANNEL,
            topic: "subscription." + e,
            data: {event: "subscription." + e, channel: t.channel, topic: t.topic}
        }
    }
    ...
    }, h = {configuration: e.extend({}, u)}, l = h.configuration, f = function (e, t) {
        this.bus = t, this.channel = e || l.DEFAULT_CHANNEL
    };
            ...
            if (!this.inactive) {
                ...
                if (c) {
                    ...
                    var a = function u(e, t) {
                        o += 1, c > o ? i[o].call(r, e, t, u) : (n.callback.call(r, e, t), s = !0)
                    };
                    a(e, t, 0)
                } else n.callback.call(r, e, t), s = !0;
                return s
            }
        }, logError: function () {
            if (console) {
    ...
    var v = (l.resolver = {
        cache: {}, regex: {}, enableCache: !0, compare: function (t, n, i) {
            var c, r, o, s = n + l.cacheKeyDelimiter + t, a = this.cache[s], u = i || {},
                h = this.enableCache && !u.resolverNoCache;
            return a === !0 ? a : -1 === t.indexOf("#") && -1 === t.indexOf("*") ? (a = n === t, h && (this.cache[s] = a), a) : ((r = this.regex[t]) || (c = "^" + e.map(t.split("."), function (e) {
                var t = "";
            ...
            var n = this, i = l.cacheKeyDelimiter, c = function (e, c) {
                var r = c.split(i), o = r[0], s = r[1];
                "undefined" != typeof t.topic && t.topic !== o || "undefined" != typeof t.binding && t.binding !== s || delete n.cache[c]
            }, r = function (e, t) {
                var c = t.split(i);
                0 === h.getSubscribersFor({topic: c[0]}).length && delete n.cache[t]
            };
            if ("undefined" == typeof t) this.reset(); else {
                var o = t.compact === !0 ? r : c;
                e.each(this.cache, o)
            }
        }
    }, 0), y = [], m = 0, g = o.bind(n, "created"), w = o.bind(n, "removed");
    if (e.extend(h, {
        cache: {},
        subscriptions: {},
        wireTaps: [],
        ChannelDefinition: f,
        SubscriptionDefinition: p,
        channel: function (e) {
            return new f(e, this)
        },
        ...
        getSubscribersFor: function (t) {
            ...
            return e.each(i.subscriptions, function (i) {
                e.each(i, function (i) {
                    n = n.concat(e.filter(i, s(t, l.resolver)))
                })
            }), n
        },
        publish: function (t, n) {
            ++v;
            var c = t.channel = t.channel || l.DEFAULT_CHANNEL, o = t.topic;
            t.timeStamp = new Date, this.wireTaps.length && e.each(this.wireTaps, function (e) {
                e(t.data, t, v)
            });
            var s = c + l.cacheKeyDelimiter + o, a = this.cache[s], u = 0, h = 0;
            if (a) e.each(a, function (e) {
                e.invokeSubscriber(t.data, t) ? h++ : u++
            }); else {
                var f = r(o, this.cache, s, function (e) {
                    e.invokeSubscriber(t.data, t) ? h++ : u++
                }, t);
            ...
            0 === --v && i(), n && n({activated: h, skipped: u})
        },
        reset: function () {
            this.unsubscribeFor(), l.resolver.reset(), this.subscriptions = {}, this.cache = {}
        },
        subscribe: function (t) {
            var n, i = this.subscriptions, c = new p(t.channel || l.DEFAULT_CHANNEL, t.topic, t.callback),
                o = i[c.channel], s = c.channel.length;
            o || (o = i[c.channel] = {}), n = i[c.channel][c.topic], n || (n = i[c.channel][c.topic] = []), n.push(c);
            var a = this.cache;
            return e.each(e.keys(a), function (e) {
                e.substr(0, s) === c.channel && r(e.split(l.cacheKeyDelimiter)[1], a, e)(c)
            }), l.enableSystemMessages && this.publish(g(c)), c
        },
        unsubscribe: function () {
            for (var t, n, i, r, o = arguments.length, s = 0; o > s; s++) {
                if (t = arguments[s], t.inactive = !0, v) return void y.push(t);
                if (n = this.subscriptions[t.channel], i = n && n[t.topic]) {
                    ...
                    if (0 === i.length && (delete n[t.topic], e.keys(n).length || delete this.subscriptions[t.channel]), t.cacheKeys && t.cacheKeys.length) for (var u; u = t.cacheKeys.pop();) e.each(this.cache[u], c(t, u, this.cache));
                    if ("function" == typeof l.resolver.purge) {
                        var h = l.autoCompactResolver === !0 ? 0 : "number" == typeof l.autoCompactResolver ? l.autoCompactResolver - 1 : !1;
                        h >= 0 && m === h ? (l.resolver.purge({compact: !0}), m = 0) : h >= 0 && h > m && (m += 1)
                    }
                }
                l.enableSystemMessages && this.publish(w(t))
            }
        },
    ...
    }), t && Object.prototype.hasOwnProperty.call(t, "__postalReady__") && e.isArray(t.__postalReady__)) for (; t.__postalReady__.length;) t.__postalReady__.shift().onReady(h);
    return h
});